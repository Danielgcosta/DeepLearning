/** 
 * Matrix4x4.h
 * Template class definition for create and handle 4x4 matrices.
 * 
 * @author: Eder A. Perez.
 */
...
namespace MSA
{
    ...
    template<typename T> class Matrix4x4
    {
        ...
        /**
         * Multiply a matrix by a 3D vector. Actually the 3D vector is considered
         * as a 4D vector with 1.0 in its w coordinate (homogeneous coordinate).
         * 
         * @param v A 3D vector.
        ...
        {
            return Vector3D<T>(_m[ 0] * v.x + _m[ 4] * v.y + _m[ 8] * v.z + _m[12] * 1.0,
                               _m[ 1] * v.x + _m[ 5] * v.y + _m[ 9] * v.z + _m[13] * 1.0,
                               _m[ 2] * v.x + _m[ 6] * v.y + _m[10] * v.z + _m[14] * 1.0);
        }
        ...
        /** Stores the sixteen values of the 4x4 matrix. */
        T _m[16];
    };
