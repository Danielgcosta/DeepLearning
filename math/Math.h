/** 
 * Math.h
 * This header defines several mathematical functions and constants.
 * 
 * @author: Eder A. Perez.
 */
...
namespace MSA
{
    template<typename T> class Math
    {
        ...
        /** Represents a very small floating point value. */
        static const T EPSILON;       

        /** Represents an approximation of pi number. */
        static const T PI;

        /** Represents an approximation of pi / 2. */
        static const T HALF_PI;       
        
        /** Represents an approximation of 180 / pi. */
        static const T _180_OVER_PI;  
        
        /** Represents an approximation of pi / 180. */
